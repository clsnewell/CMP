...
FishLiverData_SpeciesBothSeasons<- FishLiverData_040722 %>% filter(Species == c("SB",  "ST",  "YFG", "SG",  "SCP", "SKG", "TP"))
...
FishMuscleData_SpeciesBothSeasons<- FishMuscleData_040722 %>% filter(Species == c("SCP", "ST",  "TP",  "SB",  "YFG", "SKG", "SG"))
...
View(LargeMacroinvert_IsotopeAndMetaData_040422)
#Introduce Season column
LargeMacroinvert_IsotopeAndMetaData_040422$Collection_Date<-mdy(LargeMacroinvert_IsotopeAndMetaData_040422$Collection_Date)

str(LargeMacroinvert_IsotopeAndMetaData_040422$Collection_Date)

LargeMacroinvert_IsotopeAndMetaData_040422$Month<- format(LargeMacroinvert_IsotopeAndMetaData_040422$Collection_Date, format = "%m")
unique(LargeMacroinvert_IsotopeAndMetaData_040422$Month)

LargeMacroinvert_IsotopeAndMetaData_040422$Season[LargeMacroinvert_IsotopeAndMetaData_040422$Month %in% "06"]<-"Summer"
LargeMacroinvert_IsotopeAndMetaData_040422$Season[LargeMacroinvert_IsotopeAndMetaData_040422$Month %in% "07"]<-"Summer"
LargeMacroinvert_IsotopeAndMetaData_040422$Season[LargeMacroinvert_IsotopeAndMetaData_040422$Month %in% "08"]<-"Fall"
LargeMacroinvert_IsotopeAndMetaData_040422$Season[LargeMacroinvert_IsotopeAndMetaData_040422$Month %in% "09"]<-"Fall"
View(LargeMacroinvert_IsotopeAndMetaData_040422)


BigInvertsSummer<-subset(LargeMacroinvert_IsotopeAndMetaData_040422, Season == "Summer")
BigInvertsFall<-subset(LargeMacroinvert_IsotopeAndMetaData_040422, Season == "Fall")
...
unique(LargeMacroinvert_IsotopeAndMetaData_040422$Species)
