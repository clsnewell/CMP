...
AvgData_BothSeasons_Livers$Class[AvgData_BothSeasons_Livers$Species %in% c("ST", "TP", "SB")]<- "Fish"
...
AvgData_BothSeasons_Livers$Class[AvgData_BothSeasons_Livers$Species %in% "Red swamp crayfish"]<- "RSC"
...
unique(AvgData_BothSeasons_Livers$Species)

unique(AvgData_BothSeasons_Livers$Class)
AvgData_BothSeasons_Livers$Class<- factor(AvgData_BothSeasons_Livers$Class, levels = c("Fish", "Sculpin/Goby", "RSC", "HMC", "EXO", "Corbicula", "Maeotias", "Isopod", "Scud", "Crab Zoea", "Zoop", "Terrestrial", "EV", "Floating Veg", "SAV", "POM", "Benthic Algae", "Det")) #Changing level order 

#Gotta split the seasons up. Too much data!
AvgData_Summer_Livers<-AvgData_BothSeasons_Livers %>% filter(Season %in% "Summer")

Avg_Summer_Livers<- AvgData_Summer_Livers %>% ggplot(aes(D13C_mean, D15N_mean, color= Class)) + 
