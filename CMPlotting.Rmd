...
View(LargeMacroinvert_IsotopeAndMetaData_050222)
...
### SB plot
```{r}
SB.Plot<- AllData.Livers_BothSeasons_Sites_MeansSd %>% filter(Species%in%c("SB", ">500 um", "200-500 um", "A. sinensis", "P. forbesi", "100-500 um")) %>% ggplot(aes(D13C_mean, D15N_mean, color= Site)) + 
  geom_point(aes(color = Site, shape = Species), size=3) + 
