...
FishLiversSummer<-subset(FishLiverData_050222, Season == "Summer")
FishLiversFall<-subset(FishLiverData_050222, Season == "Fall")
...
unique(FishLiverData_050222$Species)

FishLiverData_SpeciesBothSeasons<- FishLiverData_050222 %>% filter(Species %in% c("SB",  "ST",  "YFG", "SG",  "SCP", "SKG", "TP"))
...
LargeMacroinvert_IsotopeAndMetaData_050222$`D13CVPDB(permill)`<- as.numeric(LargeMacroinvert_IsotopeAndMetaData_050222$`D13CVPDB(permill)`)

LargeMacroinvert_IsotopeAndMetaData_050222$`D15NAir(permill)`<- as.numeric(LargeMacroinvert_IsotopeAndMetaData_050222$`D15NAir(permill)`)

LargeMacroinvert_IsotopeAndMetaData_050222$`D34SVCDT(permill)`<- as.numeric(LargeMacroinvert_IsotopeAndMetaData_050222$`D34SVCDT(permill)`)


BigInvertsSummer<-subset(LargeMacroinvert_IsotopeAndMetaData_050222, Season == "Summer")

BigInvertsFall<-subset(LargeMacroinvert_IsotopeAndMetaData_050222, Season == "Fall")
...
unique(LargeMacroinvert_IsotopeAndMetaData_050222$Species)
...
BigInverts_BothSeasons_MeansSd<-LargeMacroinvert_IsotopeAndMetaData_050222%>% 
...
SmallMacroinvert_IsotopeAndMetaData_050222$`D13CVPDB(permill)`<- as.numeric(SmallMacroinvert_IsotopeAndMetaData_050222$`D13CVPDB(permill)`)

SmallMacroinvert_IsotopeAndMetaData_050222$`D15NAir(permill)`<- as.numeric(SmallMacroinvert_IsotopeAndMetaData_050222$`D15NAir(permill)`)

SmallMacroinvert_IsotopeAndMetaData_050222$`D34SVCDT(permill)`<- as.numeric(SmallMacroinvert_IsotopeAndMetaData_050222$`D34SVCDT(permill)`)


SmallInvertsSummer<-subset(SmallMacroinvert_IsotopeAndMetaData_050222, Season == "Summer")
unique(SmallInvertsSummer$Species)

SmallInvertsFall<-subset(SmallMacroinvert_IsotopeAndMetaData_050222, Season == "Fall")
...
SmallInverts_SpeciesBothSeasons<- SmallMacroinvert_IsotopeAndMetaData_050222 %>% filter(Species %in% c("Americorophium spinicorne", "Crab Zoea", "Eogammarus confervicolus", "Gammarus daiberi", "Gnorimosphaeroma insulare"))
...
Plants_Summer<-subset(PlantIsotopeAndMetaData_050222, Season == "Summer")
PlantsFall<-subset(PlantIsotopeAndMetaData_050222, Season == "Fall")
...
Plants_SpeciesBothSeasons<- PlantIsotopeAndMetaData_050222 %>% filter(Species %in% c("Sarcocornia/Salicornia pacifica", "Schoenoplectus acutusa", "Typha angustifolia", "Rosa californica", "Calystegia sepium", "Phragmites australis", "SAGO", "Myriophyllum spicatum", "Lemna sp", "Filamentous algae", "Lathyrus jepsonii jepsonii", "Schoenoplectus americanus", "Det"))
...
ZoopIsotopeAndMetaData_050222$Species<-ZoopIsotopeAndMetaData_050222$ZoopSpecies
Zoops_Summer<-subset(ZoopIsotopeAndMetaData_050222, Season == "Summer")
ZoopsFall<-subset(ZoopIsotopeAndMetaData_050222, Season == "Fall")
...
unique(ZoopIsotopeAndMetaData_050222$Species)

Zoops_SpeciesBothSeasons<- ZoopIsotopeAndMetaData_050222 %>% filter(Species %in% c( ">500 um", "200-500 um", "A. sinensis", "P. forbesi", "100-500 um"))
...
Zoops_SpeciesBothSeasons$`D15NAir(permill)`<-Zoops_SpeciesBothSeasons$`D15NAir(permill)...8`
...
LargeInvert_SpeciesBothSeason<- LargeMacroinvert_IsotopeAndMetaData_050222[,c("Species", "Site", "Season", "D13CVPDB(permill)", "D15NAir(permill)", "SpecimenID")]
...
AllData_BothSeasons_MeansSd$D13C_StdError[is.nan(AllData_BothSeasons_MeansSd$D13C_StdError)]<-0
...
AllData_BothSeasons_MeansSd$D15N_StdError[is.nan(AllData_BothSeasons_MeansSd$D15N_StdError)]<-0
...
AllData_Seasons<- AllData_BothSeasons_MeansSd %>% ggplot(aes(D13C_mean, D15N_mean, color= Site)) + 
  ...
  labs(title = "All data Means And Standard Error from Summer and Fall") +
  theme_bw()+
  #coord_cartesian(ylim=c(10, 15),  xlim=c(-35, -25))+
  geom_errorbar(aes(ymin = D15N_mean-D15N_StdError, ymax = D15N_mean+D15N_StdError))+
  geom_errorbarh(aes(xmin = D13C_mean-D13C_StdError, xmax = D13C_mean+D13C_StdError)) + 
...
```{r}
#Bind rows
AvgData_BothSeasons_Livers<-rbind(Zoops_BothSeasons_MeansSd, POMBA_BothSeasons_MeansSd, Plants_BothSeasons_MeanSd, SmallInverts_BothSeasons_MeansSd, BigInverts_BothSeasons_MeansSd, FishLivers_BothSeasons_MeansSd)
...
Avg_BothSeasons_Livers<- AvgData_BothSeasons_Livers  %>%  ggplot(aes(D13C_mean, D15N_mean, color= Season)) + scale_shape_manual(values=rep(0:6, 7))+
  geom_point(aes(color = Season, shape = Class)) +
...
```{r}
AllData.Livers<-rbind(Zoop_SpeciesBothSeason, POMBA_SpeciesBothSeason, Plant_SpeciesBothSeason, SmallInvert_SpeciesBothSeason, LargeInvert_SpeciesBothSeason, FishLiver_SpeciesBothSeason)

AllData.Livers$Site[AllData.Livers$Site %in% "SB"]<-"FM"
AllData.Livers_BothSeasons_Sites_MeansSd<-AllData.Livers%>% 
...
AllData.Livers_BothSeasons_Sites_MeansSd$D13C_StdError[is.nan(AllData.Livers_BothSeasons_Sites_MeansSd$D13C_StdError)]<-0

AllData.Livers_BothSeasons_Sites_MeansSd$D13C_SD[is.nan(AllData.Livers_BothSeasons_Sites_MeansSd$D13C_SD)]<-0

AllData.Livers_BothSeasons_Sites_MeansSd$D13C_UCI[is.nan(AllData.Livers_BothSeasons_Sites_MeansSd$D13C_UCI)]<-0

AllData.Livers_BothSeasons_Sites_MeansSd$D13C_LCI[is.nan(AllData.Livers_BothSeasons_Sites_MeansSd$D13C_LCI)]<-0

AllData.Livers_BothSeasons_Sites_MeansSd$D15N_SD[is.nan(AllData.Livers_BothSeasons_Sites_MeansSd$D15N_SD)]<-0

AllData.Livers_BothSeasons_Sites_MeansSd$D15N_StdError[is.nan(AllData.Livers_BothSeasons_Sites_MeansSd$D15N_StdError)]<-0

AllData.Livers_BothSeasons_Sites_MeansSd$D15N_UCI[is.nan(AllData.Livers_BothSeasons_Sites_MeansSd$D15N_UCI)]<-0

AllData.Livers_BothSeasons_Sites_MeansSd$D15N_LCI[is.nan(AllData.Livers_BothSeasons_Sites_MeansSd$D15N_LCI)]<-0

AllData.Livers_BothSeasons_Sites_MeansSd$Class[AllData.Livers_BothSeasons_Sites_MeansSd$Species %in% c("SAGO", "Myriophyllum spicatum", "Filamentous algae")]<- "SAV"

AllData.Livers_BothSeasons_Sites_MeansSd$Class[AllData.Livers_BothSeasons_Sites_MeansSd$Species %in% c("Phragmites australis", "Typha angustifolia", "Schoenoplectus acutusa", "Schoenoplectus americanus", "Schoenoplectus californicus")]<- "EV"

AllData.Livers_BothSeasons_Sites_MeansSd$Class[AllData.Livers_BothSeasons_Sites_MeansSd$Species %in% c("Sarcocornia/Salicornia pacifica", "Calystegia sepium", "Jaumea carnosa", "Lepidium latifolium", "Rosa californica", "Lathyrus jepsonii jepsonii", "Juncus balticus", "Lotus corniculatu", "Pluchea odorata")]<- "Terrestrial"

AllData.Livers_BothSeasons_Sites_MeansSd$Class[AllData.Livers_BothSeasons_Sites_MeansSd$Species %in% c("Lemna sp", "Azolla")]<- "Floating Veg"

AllData.Livers_BothSeasons_Sites_MeansSd$Class[AllData.Livers_BothSeasons_Sites_MeansSd$Species %in% "DET"]<- "Det"

AllData.Livers_BothSeasons_Sites_MeansSd$Class[AllData.Livers_BothSeasons_Sites_MeansSd$Species %in% c("SCP", "SG", "YFG", "SKG")]<- "Sculpin/Goby"

AllData.Livers_BothSeasons_Sites_MeansSd$Class[AllData.Livers_BothSeasons_Sites_MeansSd$Species %in% "ST"]<- "ST"

AllData.Livers_BothSeasons_Sites_MeansSd$Class[AllData.Livers_BothSeasons_Sites_MeansSd$Species %in% "TP"]<- "TP"

AllData.Livers_BothSeasons_Sites_MeansSd$Class[AllData.Livers_BothSeasons_Sites_MeansSd$Species %in% "SB"]<- "SB"

AllData.Livers_BothSeasons_Sites_MeansSd$Class[AllData.Livers_BothSeasons_Sites_MeansSd$Species %in% c("Americorophium spinicorne", "Eogammarus confervicolus", "Gammarus daiberi")]<- "Scud"

AllData.Livers_BothSeasons_Sites_MeansSd$Class[AllData.Livers_BothSeasons_Sites_MeansSd$Species %in% c("Red swamp crayfish")]<- "Red swamp crayfish"

AllData.Livers_BothSeasons_Sites_MeansSd$Class[AllData.Livers_BothSeasons_Sites_MeansSd$Species %in% "Harris mud crab"]<- "HMC"

AllData.Livers_BothSeasons_Sites_MeansSd$Class[AllData.Livers_BothSeasons_Sites_MeansSd$Species %in% "Maeotias"]<- "Maeotias"

AllData.Livers_BothSeasons_Sites_MeansSd$Class[AllData.Livers_BothSeasons_Sites_MeansSd$Species %in% "Exopalaemon"]<- "EXO"

AllData.Livers_BothSeasons_Sites_MeansSd$Class[AllData.Livers_BothSeasons_Sites_MeansSd$Species %in% "Corbicula"]<- "Corbicula"

AllData.Livers_BothSeasons_Sites_MeansSd$Class[AllData.Livers_BothSeasons_Sites_MeansSd$Species %in% "Gnorimosphaeroma insulare"]<- "Isopod"

AllData.Livers_BothSeasons_Sites_MeansSd$Class[AllData.Livers_BothSeasons_Sites_MeansSd$Species %in% "Crab Zoea"]<- "Crab Zoea"

AllData.Livers_BothSeasons_Sites_MeansSd$Class[AllData.Livers_BothSeasons_Sites_MeansSd$Species %in% "POM"]<- "POM"

AllData.Livers_BothSeasons_Sites_MeansSd$Class[AllData.Livers_BothSeasons_Sites_MeansSd$Species %in% "Det"]<- "Det"

AllData.Livers_BothSeasons_Sites_MeansSd$Class[AllData.Livers_BothSeasons_Sites_MeansSd$Species %in% "Benthic"]<- "Benthic Algae"

AllData.Livers_BothSeasons_Sites_MeansSd$Class[AllData.Livers_BothSeasons_Sites_MeansSd$Species %in% c("P. forbesi", "A. sinensis", "200-500 um", "100-500 um" ,">500 um")]<- "Zoop"

AllData.Livers_BothSeasons_Sites_MeansSd$D15N_SD[AllData.Livers_BothSeasons_Sites_MeansSd$D15N_SD %in% c("NaN", "NA")]<- "0"
AllData.Livers_BothSeasons_Sites_MeansSd$D15N_SD<-as.numeric(AllData.Livers_BothSeasons_Sites_MeansSd$D15N_SD)

AllData.Livers_BothSeasons_Sites_MeansSd$D13C_SD[AllData.Livers_BothSeasons_Sites_MeansSd$D13C_SD %in% c("NaN", "NA")]<- "0"
AllData.Livers_BothSeasons_Sites_MeansSd$D13C_SD<-as.numeric(AllData.Livers_BothSeasons_Sites_MeansSd$D13C_SD)

View(AllData.Livers_BothSeasons_Sites_MeansSd)

unique(AllData.Livers_BothSeasons_Sites_MeansSd$Class)

View(AllData.Livers_BothSeasons_Sites_MeansSd)

AllData.Livers_BothSeasons_Sites_MeansSd$Class<- factor(AllData.Livers_BothSeasons_Sites_MeansSd$Class, levels = c("SB", "ST", "TP", "Sculpin/Goby", "Red swamp crayfish", "HMC", "Maeotias", "EXO", "Corbicula",  "Isopod", "Scud", "Crab Zoea", "Zoop", "Terrestrial", "EV", "Floating Veg", "SAV", "POM", "Benthic Algae", "Det")) #Changing level order 


AllData.Livers_Seasons<- AllData.Livers_BothSeasons_Sites_MeansSd %>% ggplot(aes(D13C_mean, D15N_mean, color= Class)) + 
  geom_point(aes(color = Class)) + 
...
### SB plot
```{r}
SmallInverts_MeansSd<-SmallMacroinvert_IsotopeAndMetaData_050222%>% 
  group_by(Species, Site, Season) %>% 
  summarize(n=n(),
            alpha = 0.05,
            D13C_mean = sum(`D13CVPDB(permill)`/n, na.rm=TRUE), 
...
SmallInverts_MeansSd$D13C_StdError[is.nan(SmallInverts_MeansSd$D13C_StdError)]<-0

SmallInverts_MeansSd$D13C_StdError[is.na(SmallInverts_MeansSd$D13C_StdError)]<-0

SmallInverts_MeansSd$D13C_SD[is.nan(SmallInverts_BothSeasons_MeansSd$D13C_SD)]<-0

SmallInverts_MeansSd$D13C_UCI[is.nan(SmallInverts_MeansSd$D13C_UCI)]<-0

SmallInverts_MeansSd$D13C_LCI[is.nan(SmallInverts_MeansSd$D13C_LCI)]<-0

SmallInverts_MeansSd$D15N_StdError[is.nan(SmallInverts_MeansSd$D15N_StdError)]<-0

SmallInverts_MeansSd$D15N_StdError[is.na(SmallInverts_MeansSd$D15N_StdError)]<-0

SmallInverts_MeansSd$D15N_SD[is.nan(SmallInverts_MeansSd$D15N_SD)]<-0

SmallInverts_MeansSd$D15N_UCI[is.nan(SmallInverts_MeansSd$D15N_UCI)]<-0

SmallInverts_MeansSd$D15N_LCI[is.nan(SmallInverts_MeansSd$D15N_LCI)]<-0

POMBA_BothSeasons_MeansSd$Species<- POMBA_BothSeasons_MeansSd$`Sample Type`

AvgData__Livers<-rbind(Zoops_BothSeasons_MeansSd, POMBA_BothSeasons_MeansSd, Plants_BothSeasons_MeanSd, SmallInverts_MeansSd, BigInverts_BothSeasons_MeansSd, FishLivers_BothSeasons_MeansSd)

AvgData__Livers$Species<- factor(AvgData__Livers$Species, levels = c("SB", "ST", "SCP", "YFG", "Exopalaemon", "Harris mud crab", "Mysid", "Americorophium spinicorne", "Eogammarus confervicolus", "Gammarus daiberi", "A. sinensis", "P. forbesi",">500 um", "200-500 um", "100-500 um", "Sarcocornia/Salicornia pacifica", "Schoenoplectus acutusa", "SAGO", "POM", "BA")) #Changing level order 

SB.Plot<- AvgData__Livers %>% filter(Species%in%c("SB", ">500 um", "200-500 um", "A. sinensis", "P. forbesi", "100-500 um", "Mysid", "Americorophium spinicorne")) %>% ggplot(aes(D13C_mean, D15N_mean, color= Site)) + 
  geom_point(aes(color = Site, shape = Species), size=3) + scale_shape_manual(values=rep(0:6, 1))+ 
  labs(title = "Striped Bass Livers and Zooplankton: Carbon, Nitrogen Means And Standard Error from Summer and Fall") +
  theme_bw()+
  geom_errorbar(aes(ymin = D15N_mean-D15N_StdError, ymax = D15N_mean+D15N_StdError))+
  geom_errorbarh(aes(xmin = D13C_mean-D13C_StdError, xmax = D13C_mean+D13C_StdError)) +  facet_wrap(~factor(Season, levels=c("Summer", "Fall")))
SB.Plot
...
### SCP Plot
```{r}
#SCP, scuds, primary producers
AvgData__Livers$Species<- as.factor(AvgData__Livers$Species)
SCP.Plot<- AvgData__Livers %>% filter(Species%in%c("SCP", "Americorophium spinicorne", "Eogammarus confervicolus", "Gammarus daiberi", "Sarcocornia/Salicornia pacifica", "Schoenoplectus acutusa", "SAGO", "POM", "BA")) %>% ggplot(aes(D13C_mean, D15N_mean, color= Site)) + 
  geom_point(aes(color = Site, shape = Species), size=3) + scale_shape_manual(values=rep(0:7, 1))+
  labs(title = "Prickly Sculpin, scuds, primary producers: carbon, nitrogen means and standard error from summer and fall") +
  theme_bw()+
  geom_errorbar(aes(ymin = D15N_mean-D15N_StdError, ymax = D15N_mean+D15N_StdError))+
  geom_errorbarh(aes(xmin = D13C_mean-D13C_StdError, xmax = D13C_mean+D13C_StdError)) +  facet_wrap(~factor(Season, levels=c("Summer", "Fall")))
SCP.Plot
...
Striped Bass Plots
```{r}
#plot striped bass with copepods (zoops) and mysids
