...
AllData.Livers_BothSeasons_MeansSd<-AllData.Livers%>% 
...
AllData.Livers_BothSeasons_MeansSd$D13C_StdError[is.nan(AllData.Livers_BothSeasons_MeansSd$D13C_StdError)]<-0

AllData.Livers_BothSeasons_MeansSd$D13C_SD[is.nan(AllData.Livers_BothSeasons_MeansSd$D13C_SD)]<-0

AllData.Livers_BothSeasons_MeansSd$D13C_UCI[is.nan(AllData.Livers_BothSeasons_MeansSd$D13C_UCI)]<-0

AllData.Livers_BothSeasons_MeansSd$D13C_LCI[is.nan(AllData.Livers_BothSeasons_MeansSd$D13C_LCI)]<-0

AllData.Livers_BothSeasons_MeansSd$D15N_SD[is.nan(AllData.Livers_BothSeasons_MeansSd$D15N_SD)]<-0

AllData.Livers_BothSeasons_MeansSd$D15N_StdError[is.nan(AllData.Livers_BothSeasons_MeansSd$D15N_StdError)]<-0

AllData.Livers_BothSeasons_MeansSd$D15N_UCI[is.nan(AllData.Livers_BothSeasons_MeansSd$D15N_UCI)]<-0

AllData.Livers_BothSeasons_MeansSd$D15N_LCI[is.nan(AllData.Livers_BothSeasons_MeansSd$D15N_LCI)]<-0

AllData.Livers_BothSeasons_MeansSd$Class[AllData.Livers_BothSeasons_MeansSd$Species %in% c("SAGO", "Myriophyllum spicatum", "Filamentous algae")]<- "SAV"

AllData.Livers_BothSeasons_MeansSd$Class[AllData.Livers_BothSeasons_MeansSd$Species %in% c("Phragmites australis", "Typha angustifolia", "Schoenoplectus acutusa", "Schoenoplectus americanus", "Schoenoplectus californicus")]<- "EV"

AllData.Livers_BothSeasons_MeansSd$Class[AllData.Livers_BothSeasons_MeansSd$Species %in% c("Sarcocornia/Salicornia pacifica", "Calystegia sepium", "Jaumea carnosa", "Lepidium latifolium", "Rosa californica", "Lathyrus jepsonii jepsonii", "Juncus balticus", "Lotus corniculatu", "Pluchea odorata")]<- "Terrestrial"

AllData.Livers_BothSeasons_MeansSd$Class[AllData.Livers_BothSeasons_MeansSd$Species %in% c("Lemna sp", "Azolla")]<- "Floating Veg"

AllData.Livers_BothSeasons_MeansSd$Class[AllData.Livers_BothSeasons_MeansSd$Species %in% "DET"]<- "Det"

AllData.Livers_BothSeasons_MeansSd$Class[AllData.Livers_BothSeasons_MeansSd$Species %in% c("SCP", "SG", "YFG", "SKG")]<- "Sculpin/Goby"

AllData.Livers_BothSeasons_MeansSd$Class[AllData.Livers_BothSeasons_MeansSd$Species %in% "ST"]<- "ST"

AllData.Livers_BothSeasons_MeansSd$Class[AllData.Livers_BothSeasons_MeansSd$Species %in% "TP"]<- "TP"

AllData.Livers_BothSeasons_MeansSd$Class[AllData.Livers_BothSeasons_MeansSd$Species %in% "SB"]<- "SB"

AllData.Livers_BothSeasons_MeansSd$Class[AllData.Livers_BothSeasons_MeansSd$Species %in% c("Americorophium spinicorne", "Eogammarus confervicolus", "Gammarus daiberi")]<- "Scud"

AllData.Livers_BothSeasons_MeansSd$Class[AllData.Livers_BothSeasons_MeansSd$Species %in% c("Red swamp crayfish")]<- "Red swamp crayfish"

AllData.Livers_BothSeasons_MeansSd$Class[AllData.Livers_BothSeasons_MeansSd$Species %in% "Harris mud crab"]<- "HMC"

AllData.Livers_BothSeasons_MeansSd$Class[AllData.Livers_BothSeasons_MeansSd$Species %in% "Maeotias"]<- "Maeotias"

AllData.Livers_BothSeasons_MeansSd$Class[AllData.Livers_BothSeasons_MeansSd$Species %in% "Exopalaemon"]<- "EXO"

AllData.Livers_BothSeasons_MeansSd$Class[AllData.Livers_BothSeasons_MeansSd$Species %in% "Corbicula"]<- "Corbicula"

AllData.Livers_BothSeasons_MeansSd$Class[AllData.Livers_BothSeasons_MeansSd$Species %in% "Gnorimosphaeroma insulare"]<- "Isopod"

AllData.Livers_BothSeasons_MeansSd$Class[AllData.Livers_BothSeasons_MeansSd$Species %in% "Crab Zoea"]<- "Crab Zoea"

AllData.Livers_BothSeasons_MeansSd$Class[AllData.Livers_BothSeasons_MeansSd$Species %in% "POM"]<- "POM"

AllData.Livers_BothSeasons_MeansSd$Class[AllData.Livers_BothSeasons_MeansSd$Species %in% "Det"]<- "Det"

AllData.Livers_BothSeasons_MeansSd$Class[AllData.Livers_BothSeasons_MeansSd$Species %in% "Benthic"]<- "Benthic Algae"

AllData.Livers_BothSeasons_MeansSd$Class[AllData.Livers_BothSeasons_MeansSd$Species %in% c("P. forbesi", "A. sinensis", "200-500 um", "100-500 um" ,">500 um")]<- "Zoop"

AllData.Livers_BothSeasons_MeansSd$D15N_SD[AllData.Livers_BothSeasons_MeansSd$D15N_SD %in% c("NaN", "NA")]<- "0"
AllData.Livers_BothSeasons_MeansSd$D15N_SD<-as.numeric(AllData.Livers_BothSeasons_MeansSd$D15N_SD)

AllData.Livers_BothSeasons_MeansSd$D13C_SD[AllData.Livers_BothSeasons_MeansSd$D13C_SD %in% c("NaN", "NA")]<- "0"
AllData.Livers_BothSeasons_MeansSd$D13C_SD<-as.numeric(AllData.Livers_BothSeasons_MeansSd$D13C_SD)

View(AllData.Livers_BothSeasons_MeansSd)

unique(AllData.Livers_BothSeasons_MeansSd$Class)

View(AllData.Livers_BothSeasons_MeansSd)
AllData.Livers_BothSeasons_MeansSd$Class<- factor(AllData.Livers_BothSeasons_MeansSd$Class, levels = c("SB", "ST", "TP", "Sculpin/Goby", "Red swamp crayfish", "HMC", "Maeotias", "EXO", "Corbicula",  "Isopod", "Scud", "Crab Zoea", "Zoop", "Terrestrial", "EV", "Floating Veg", "SAV", "POM", "Benthic Algae", "Det")) #Changing level order 


AllData.Livers_Seasons<- AllData.Livers_BothSeasons_MeansSd %>% ggplot(aes(D13C_mean, D15N_mean, color= Class)) + 
  geom_point(aes(color = Class)) + 
