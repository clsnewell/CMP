...
## Now zoops
```{r}
ZoopIsotopeData<- RawIsotopeData_04252022 %>% filter(Taxon == "ZOOP")
...
write.csv(ZoopIsotopeAndMetadata, "Data/ZoopIsotopeAndMetaData_042522.csv")
```
...
```{r}
InvertIsotopeData<- RawIsotopeData_04252022 %>% filter(Taxon == "INVERT")
...
write.csv(LargeMacroinvert_IsotopeAndMetadata, "Data/LargeMacroinvert_IsotopeAndMetaData_042522.csv")
...
write.csv(SmallMacroinvert_IsotopeAndMetadata, "Data/SmallMacroinvert_IsotopeAndMetaData_042522.csv")
```