...
Raw_S<- bind_rows(CMPatty_S, CMPBuffPants_S, CMPChoppedLiver_S, CMPeace_S, CMPeachment_S, CMPlucheae_S, CMPLiverItUp_S, CMPLiverLaughLov_S, CMPLiverOfMine_S, CMPMuscleMeat_S, CMPoaceae_S, CMPNotFood_S,  CMPSchwarzeneger_S, CMPScuds_S, CMPTunaOfTheFarm_S, CMPISeeDeadCMPeople_S)
write.csv(Raw_S, "Data/Raw_S_04252022.csv")

#Manually added taxon columns, so read-in the excel versions of the raw data with taxon columns
RawIsotopeData_04252022 <- read_excel("Data/RawIsotopeData_04252022.xlsx")

Raw_S_04252022<- read_excel("Data/Raw_S_04252022.xlsx")
...
FishIsotopeData_S<- Raw_S_04252022 %>% filter(Taxon == "FISH")
...
write.csv(FishMuscleData, "Data/FishMuscleData_042522.csv")

write.csv(FishLiverData, "Data/FishLiverData_042522.csv")
```

## Let's do plants next.
```{r}
RawIsotopeData_04252022
str(RawIsotopeData_04252022$Taxon)
PlantIsotopeData<- RawIsotopeData_04252022 %>% filter(Taxon == "PLANT")
...
#SAVE IT
write.csv(PlantIsotopeAndMetadata, "Data/PlantIsotopeAndMetaData_042522.csv")
```
